...
class WatchConnectivityManager: NSObject, ObservableObject {
    ...
    weak var characterStats: CharacterStats?
    ...
    // MARK: - Send to iPhone
    func sendStatsToiPhone(id: UUID, energy: Int, fullness: Int, happiness: Int) {
        ...
        if session.isReachable {
            ...
            print("⌚️ watchOS: iPhone is not reachable, will try later")
...
extension WatchConnectivityManager: CharacterStatsDelegate {
    func characterStatsDidUpdate(id: UUID, energy: Int, fullness: Int, happiness: Int) {
        sendStatsToiPhone(id: id, energy: energy, fullness: fullness, happiness: happiness)
    }
}
